...
const twoRunView = `{
  "runIds": ["run-a", "run-b"],
  "added": {"run-a": ["water"], "run-b": ["prediction"]},
  "order": {"run-a": ["water"], "run-b": ["prediction"]},
  "places": {"run-a": {"x": 1, "z": 2}, "run-b": {"x": 3, "z": 4}},
  "extraState": {"run-a\u0000water": {"opacity": 0.5, "visible": true},
                 "run-b\u0000prediction": {"opacity": 1, "visible": true}},
  "planePlaces": {"run-a\u0000water": {"x": 0.25, "z": 0.5}},
