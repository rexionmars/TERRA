...
export function Stat({ label, value }: { label: string; value: string }) {
  return (
    /*
      ...
      about 200px kept the whole value and cut the label to a pixel. An
...
export function Chip({
  ...
  return (
    /* accentQuiet, not the accent. lib/contrast.ts carries the accent at 3.0
       for fills, rings and active states and says never small text;
